...
export function Testimonials() {
  return (
    <section className="relative py-24 md:py-32 bg-soft-gradient grain overflow-hidden">
      <div className="mx-auto max-w-7xl px-4">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <p className="u-eyebrow mb-3">Loved by</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          {reviews.map((r, i) => (
            <article
              key={i}
              className="u-card p-6 hover-lift flex flex-col"
            >
