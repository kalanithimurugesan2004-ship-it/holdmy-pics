      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-4">
            <p className="u-eyebrow mb-3">Why us</p>
            <h2 className="font-display text-4xl md:text-5xl font-light leading-[1.05] text-balance">
          ...
          <div className="lg:col-span-8 grid sm:grid-cols-2 gap-4">
            {items.map((it) => (
              <div key={it.title} className="u-card p-6 hover-lift">
                <div className="u-icon mb-4">
                  <it.icon size={18} />
                </div>
                <h3 className="font-display text-lg mb-1">{it.title}</h3>
                <p className="text-sm text-foreground/60">{it.text}</p>
              </div>
            ))}
          </div>
        </div>
